...
UUID = os.environ.get('UUID', '6ac6d722-cf2d-4a18-9a7a-5837b1214037')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nezha.755578.xyz:8056 ')      # 哪吒面板域名或ip, v1格式: nezha.xxx.com:8008, v0格式: nezha.xxx.com
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')          # v1哪吒请留空, v0哪吒的agent通信端口,自动匹配tls
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'dFTAQ6yzMW0tl80dXs8chNh7Q5iAMWYF')            # v1哪吒的NZ_CLIENT_SECRET或v0哪吒agent密钥
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'argo.755578.xyz')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiODYyMmRlNmEyYTk3OGJjMjNmMzAxOTZlZWVlNTk4MzgiLCJ0IjoiYzZhMGFhNmItYTIwNC00YjhmLTgxMzItNGJkMThiYjlkNDI4IiwicyI6Ik5EazFNV1JqTjJRdFl6SXhNaTAwWXpVMUxUZ3lOMlV0T1RJMlptWmxabVl3T1RNMyJ9')            # Argo固定隧道密钥,留空即使用临时隧道
ARGO_PORT = int(os.environ.get('ARGO_PORT', '8008'))   # Argo端口,使用固定隧道token需在cloudflare后台设置端口和这里一致
